...
from tensorflow.keras.layers import Input, Embedding, LSTM, Dense, BatchNormalization, Masking

# input is 21 categorical 200 paded aa sequences

from get_ec import get_ec_1_level, binarize_labels, remove_zeros
from dataset_characterization import get_counts
from get_prot_representation import deal_with_strange_aa
